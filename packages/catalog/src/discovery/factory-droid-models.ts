...
export const FACTORY_DROID_MODELS: readonly FactoryDroidModelInput[] = [
	...
	},
	{
		...
		contextWindow: 867000,
		maxTokens: 128000,
		apiProviders: ["anthropic", "vertex_anthropic", "bedrock_anthropic", "snowflake"],
		euApiProviders: ["bedrock_anthropic"],
		credits: { input: 2 },
	...
	},
	{
		...
		apiProviders: ["anthropic", "vertex_anthropic", "bedrock_anthropic"],
		euApiProviders: [],
		credits: { input: 4, cacheRead: 0.025, output: 5 },
		supportedReasoningEfforts: ["off", "low", "medium", "high", "xhigh", "max"],
		defaultReasoningEffort: "high",
		featureFlag: "claude_fable_5_1",
		thinkingStyle: "adaptive-summarized",
		refusalFallbackModels: ["claude-opus-5"],
		noImageSupport: true,
	},
	...
	},
	{
		...
		maxTokens: 128000,
		apiProviders: ["openai", "azure_openai", "bedrock_openai"],
	...
	},
	{
		...
		contextWindow: 922000,
		maxTokens: 128000,
		apiProviders: ["openai", "azure_openai", "snowflake"],
		credits: {
			input: 2,
			output: 5,
		},
	...
	},
	{
		...
		// No "off" rung: GLM-5.3's ladder starts at low and defaults to max.
	...
	{
		id: "glm-5.3-flash",
		name: "GLM-5.3 Flash (Droid Core)",
		wire: "openai-completions",
		contextWindow: 1048576,
		maxTokens: 131072,
		apiProviders: ["fireworks", "baseten"],
		credits: { input: 0.06, cacheRead: 0.2, output: 3.34 },
		supportedReasoningEfforts: ["low", "high", "max"],
		defaultReasoningEffort: "high",
		featureFlag: "glm_5_3_flash",
		completionsReasoning: { fireworks: { history: "preserved" }, baseten: { mode: "reasoning-effort" } },
		reasoningReplay: "standard",
		noImageSupport: true,
	},
