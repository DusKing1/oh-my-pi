...
pub mod matchers {
	...
	pub mod time {
		...
		/// This matcher checks whether the file is newer than the file time of
		/// any combination of two comparison types from the target file's
		/// `NewerOptionType`.
	...
	/// This is a function that converts a specific string format into a
	/// timestamp. It allows converting a time string of
	/// "(week abbreviation) (date), (year) (time)" to a Unix timestamp.
	/// such as: "jan 01, 2025 00:00:01" -> 1735689601000
	/// When (time) is not provided, it will be automatically filled in as
	/// 00:00:00 such as: "jan 01, 2025" = "jan 01, 2025 00:00:00" ->
	/// 1735689600000
