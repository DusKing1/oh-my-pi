...
pub(crate) const MARKDOWN_TAB: &str = r#"# Rendering Gallery
...
pub(crate) const MATH_TAB: &str = r"# Math
...
pub(crate) const MERMAID_TAB: &str = r"# Mermaid
...
pub(crate) const GRAPHVIZ_TAB: &str = r#"# Graphviz
