...
/// refcount bump; the lock is never held across a parse or a tree walk.
...
pub struct ParseCacheStats {
	...
	pub entries:      usize,
	/// Retained source bytes across all entries.
	pub source_bytes: usize,
	/// Lookups answered from a resident, byte-verified slot.
	pub hits:         u64,
	/// Lookups that fell through to a parse.
	pub misses:       u64,
	/// Slots dropped by the LRU bounds.
	pub evictions:    u64,
}

/// Snapshot the process-global cache's occupancy and counters.
